...
public class RankupVerifyMenu implements InventoryProvider {
    ...
    private int getTokenMultiplierByPrestige(int prestige) {
        if (prestige >= 5 && prestige < 10) {
            return 3;
        }
        if (prestige >= 10 && prestige < 15) {
            return 5;
        }
        ...
        if (prestige >= 30 && prestige < 35) {
            return 20;
        }
        if (prestige >= 35 && prestige < 40) {
            return 25;
        }
        return 1;
    }
