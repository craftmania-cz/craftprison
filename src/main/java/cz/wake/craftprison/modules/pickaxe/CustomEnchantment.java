...
public enum CustomEnchantment {
    ...
    UNBREAKING("Unbreaking", "§cUnbreaking", Material.BEDROCK, Enchantment.DURABILITY, true, 2, 3, "§7Neznicitelny krumpac", "§7je zaklad kazdeho kopani."),
    HASTE("Haste", "§aHaste", Material.BEACON, PotionEffectType.FAST_DIGGING, false, 11, 2, "§7Rychlejsi nez blesk", "§7tak to budes ty."),
    FORTUNE("Fortune", "§dFortune", Material.DIAMOND, Enchantment.LOOT_BONUS_BLOCKS, false, 7, 30, "§7S kazdou urovni dostanes", "§7vic a vic itemu", "§7z vykopanych bloku."),
    JUMP("Jump", "§fJump", Material.DIAMOND_BOOTS, PotionEffectType.JUMP, false, 5, 2, "§7Skakej jako kralik.", "§7Hlavne nepreskoc doly."),
    SOULBOUND("Soulbound", "§7Soulbound", Material.SOUL_SAND, null, true, 5, 1, "§7Podepise krumpac tvym jmenem,", "§7a kazdy pak zjisti, jak jsi super."),
