...
public enum Rank {
    ...
    B(2, "B", 1000, 1, Material.STONE, new Location(Bukkit.getWorld("spawn"), -41.5, 42, 206.5, -90, 0)), // craftprison.mine.nightvision
    C(3, "C", 4000, 1, Material.DIORITE, new Location(Bukkit.getWorld("spawn"), -110.5, 42, 275.5, 0, 0)),
    D(4, "D", 10000, 1, Material.POLISHED_DIORITE, new Location(Bukkit.getWorld("spawn"), -179.5, 42, 206.5, 90, 0)), // "Odemknuti vytvareni ostrova /is", "askyblock.island.create"
    E(5, "E", 20000, 2, Material.POLISHED_GRANITE, new Location(Bukkit.getWorld("mines"), 62.5, 108, -133.5, 0, 0)), // "Odemknuti pouzivani Aukce /au (Max 1 aukce)", "auctionguiplus.auction", "auctionguiplus.auction.bid", "auctionguiplus.auction.start", "auctionguiplus.auction.bid"
    F(6, "F", 40000, 2, Material.LIME_TERRACOTTA, new Location(Bukkit.getWorld("mines"), -161.5, 109, -49.5, -89, 0)), // "Odemknuti prikazu /pvp", "craftprison.pvp", "quicksell.shop.pvp"),
    G(7, "G", 80000, 2, Material.RED_TERRACOTTA, new Location(Bukkit.getWorld("mines"), -201.5, 118, 257.5, 0, 0)), // "Odemknuti /shop + sekce Blocks", "shopguiplus.shop", "shopguiplus.shops.blocks"),
    H(8, "H", 150000, 2, Material.BONE_BLOCK, new Location(Bukkit.getWorld("mines"), -103.1, 120, 619.8, 0, 0)), // "", ""),
    I(9, "I", 300000, 2, Material.IRON_BLOCK, new Location(Bukkit.getWorld("mines"), 17.5, 133, 1086, 0, 0)), // "Odemknuti prikazu /heads", "headdb.allow.buy", "headdb.category.*", "headdb.open"),
    J(10, "J", 500000, 2, Material.MOSSY_COBBLESTONE, new Location(Bukkit.getWorld("mines"), 82.5, 102, 1689.5, -91, 0)), // "", ""),
    K(11, "K", 800000, 3, Material.LIGHT_BLUE_CONCRETE, new Location(Bukkit.getWorld("mines"), -763.5, 77, 9.5, -90, 0)), // "Moznost pridat 3 hrace na ostrov (+1)", "askyblock.team.maxsize.3"),
    L(12, "L", 1200000, 3, Material.GOLD_ORE, new Location(Bukkit.getWorld("mines"), -1034, 133, 158.5, -89, 0)),
    M(13, "M", 1500000, 3, Material.SANDSTONE, new Location(Bukkit.getWorld("mines"), -1442.1, 113, 292.0, -89, 0)), //, "Odemknuti sekce Decorations & Foods v /shop", "shopguiplus.shops.food", "shopguiplus.shops.dekorace"),
    N(14, "N", 2000000, 3, Material.GOLD_BLOCK, new Location(Bukkit.getWorld("mines"), -1890.5, 113, 481.5, -179, 0)), //, "", ""),
    O(15, "O", 3000000, 3, Material.DARK_PRISMARINE, new Location(Bukkit.getWorld("mines"), -2130.5, 114, 542.5, 0, 0)), // "Automaticky FLY v dolech", "craftprison.mine.fly"),
    P(16, "P", 5000000, 4, Material.REDSTONE_BLOCK, new Location(Bukkit.getWorld("mines"), -2558.5, 114, 694.5, -89, 0)), //, "", ""),
    Q(17, "Q", 10000000, 4, Material.EMERALD_ORE, new Location(Bukkit.getWorld("mines"), -2940.5, 104, 791.5, -179, 0)), //, 1, (short) 15), "Odemknuti vsech sekci v /shop", "shopguiplus.shops.*"),
    R(18, "R", 20000000, 4, Material.PACKED_ICE, new Location(Bukkit.getWorld("mines"), -3457.5, 104, 838.5, 0, 0)), // "", ""),
    S(19, "S", 30000000, 4, Material.END_STONE, new Location(Bukkit.getWorld("mines"), -3531.5, 125, 491.5, -89, 0)), //
    T(20, "T", 50000000, 4, Material.EMERALD_BLOCK, new Location(Bukkit.getWorld("mines"), -3967.5, 114, 566.5, 90, 0)), //
    U(21, "U", 100000000, 5, Material.QUARTZ_BLOCK, new Location(Bukkit.getWorld("mines"), -4511.5, 145, 756.5, 179, 0)), // Calcium Pools (Bundle 1)
    V(22, "V", 250000000, 5, Material.NETHER_BRICKS, new Location(Bukkit.getWorld("mines"), -4974.5, 104, 804.5, 0, 0)), //
    W(23, "W", 500000000, 5, Material.BASALT, new Location(Bukkit.getWorld("mines"), -5593.5, 111, 969.5, 90, 0)), //
    X(24, "X", 1000000000, 5, Material.DIAMOND_ORE, new Location(Bukkit.getWorld("mines"), -6064.5, 134, 1054.5, -90, 0)), // StarWars (Bundle 1)
    Y(25, "Y", 2000000000, 5, Material.LAPIS_BLOCK, new Location(Bukkit.getWorld("mines"), -6619.5, 129, 1118.5, 0, 0)), //
    Z(26, "Z", 4000000000L, 6, Material.DIAMOND_BLOCK, new Location(Bukkit.getWorld("mines"), -6879.5, 119, 1276.5, 0, 0)); //
