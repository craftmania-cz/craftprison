...
public enum Rank {
    ...
    I(9, "I", 1000000, 2, Material.IRON_BLOCK, new Location(Bukkit.getWorld("mines"), 17.5, 133, 1086, 0, 0)), // "Odemknuti prikazu /heads", "headdb.allow.buy", "headdb.category.*", "headdb.open"),
    J(10, "J", 2000000, 2, Material.MOSSY_COBBLESTONE, new Location(Bukkit.getWorld("mines"), 82.5, 102, 1689.5, -91, 0)), // "", ""),
    ...
    N(14, "N", 60000000, 3, Material.GOLD_BLOCK, new Location(Bukkit.getWorld("mines"), -1890.5, 113, 481.5, -179, 0)), //, "", ""),
    O(15, "O", 120000000, 3, Material.DARK_PRISMARINE, new Location(Bukkit.getWorld("mines"), -2130.5, 114, 542.5, 0, 0)), // "Automaticky FLY v dolech", "craftprison.mine.fly"),
    P(16, "P", 250000000, 4, Material.REDSTONE_BLOCK, new Location(Bukkit.getWorld("mines"), -2558.5, 114, 694.5, -89, 0)), //, "", ""),
    Q(17, "Q", 500000000, 4, Material.EMERALD_ORE, new Location(Bukkit.getWorld("mines"), -2940.5, 104, 791.5, -179, 0)), //, 1, (short) 15), "Odemknuti vsech sekci v /shop", "shopguiplus.shops.*"),
    R(18, "R", 1000000000, 4, Material.PACKED_ICE, new Location(Bukkit.getWorld("mines"), -3457.5, 104, 838.5, 0, 0)), // "", ""),
    S(19, "S", 2000000000, 4, Material.END_STONE, new Location(Bukkit.getWorld("mines"), -3531.5, 125, 491.5, -89, 0)), //
    T(20, "T", 5000000000L, 4, Material.EMERALD_BLOCK, new Location(Bukkit.getWorld("mines"), -3967.5, 114, 566.5, 90, 0)), //
    U(21, "U", 10000000000L, 5, Material.QUARTZ_BLOCK, new Location(Bukkit.getWorld("mines"), -4511.5, 145, 756.5, 179, 0)), // Calcium Pools (Bundle 1)
